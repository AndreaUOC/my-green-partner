...
@section('content')
    ...
    <div class="container-fluid">
        <div class="mt-5 mb-5">
            <h1 class="display-1" style="font-family: 'Arial', sans-serif; font-size: 4rem; font-weight: bold; text-transform: uppercase; color: #333; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">{{ __('transQuestion.Welcome to the community')}}:</h1>
        </div>    
